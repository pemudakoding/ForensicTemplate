        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('administrator.our-value.update', $data->id) }}" method="post"
                            ...
                            <x-inputs.form-group class="row mb-4">
                                <x-inputs.label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"
                            ...
                            <x-inputs.form-group class="row mb-4">
                                <x-inputs.label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"
                                    value="Icon" inline="true" />
                                <div class="col-sm-12 col-md-7">
                                    <x-alerts.alert-simple type='info' msg='(Opsional)' />
                                    <x-inputs.file name='icon'/>
                                    @error('icon')
                                        <x-alerts.alert-simple type='danger' :msg=$message />
                                    @enderror
                                </div>
